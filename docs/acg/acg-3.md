...
F-15E fuel capacity varies based on configuration and mission requirements. Tank capacities (using JP-8 at 65°F):
...
* **OPEN:**
    ...
    * CG control: Float switch in tank 1 prevents external tank filling until tank 1 has ≥1560 lbs.
...
* To aid tank 1 gravity transfer: Maintain 3° to 7° nose-up pitch.
...
* CFTs: Normal max imbalance ≤500 lbs. Sustained imbalance ≥1000 lbs for >5 minutes requires write-up.
* Internal wing tanks: Sustained imbalance ≥200 lbs for >5 minutes requires write-up.
...
11. Determine the correct situation from the fuel gauge readings (Figure F-1).
    a) The external tanks are full.
    b) The right feed tank has an invalid reading.
    c) The right internal wing has 1100 lbs more than the left.
    d) Tank 1 total fuel is 3100 lbs.

[Figure F-1]

12. Determine the correct situation from the fuel gauge readings (Figure F-2).
